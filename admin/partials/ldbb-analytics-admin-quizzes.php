<?php
/**
 * Admin quiz statistics view for LearnDash BuddyBoss Analytics
 *
 * This file provides the markup for the quiz statistics page of the plugin
 */
?>

<div class="wrap">
    <h1><?php echo esc_html__('Quiz Statistics', 'learndash-buddyboss-analytics'); ?></h1>
    
    <div class="ldbb-analytics-app-container">
        <!-- React App will be mounted here -->
        <div id="ldbb-analytics-quiz-stats-root"></div>
    </div>
