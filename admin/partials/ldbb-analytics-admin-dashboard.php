<?php
/**
 * Admin dashboard view for LearnDash BuddyBoss Analytics
 *
 * This file provides the markup for the admin dashboard of the plugin
 */
?>

<div class="wrap">
    <h1><?php echo esc_html__('LearnDash BuddyBoss Analytics Dashboard', 'learndash-buddyboss-analytics'); ?></h1>
    
    <div class="ldbb-analytics-app-container">
        <!-- React App will be mounted here -->
        <div id="ldbb-analytics-root"></div>
    </div>
