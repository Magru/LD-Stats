<?php
/**
 * Admin courses statistics view for LearnDash BuddyBoss Analytics
 *
 * This file provides the markup for the course statistics page of the plugin
 */
?>

<div class="wrap">
    <h1><?php echo esc_html__('Course Statistics', 'learndash-buddyboss-analytics'); ?></h1>
    
    <div class="ldbb-analytics-app-container">
        <!-- React App will be mounted here -->
        <div id="ldbb-analytics-course-stats-root"></div>
    </div>
