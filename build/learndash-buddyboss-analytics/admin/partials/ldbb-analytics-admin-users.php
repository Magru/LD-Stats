<?php
/**
 * Admin user statistics view for LearnDash BuddyBoss Analytics
 *
 * This file provides the markup for the user statistics page of the plugin
 */
?>

<div class="wrap">
    <h1><?php echo esc_html__('User Statistics', 'learndash-buddyboss-analytics'); ?></h1>
    
    <div class="ldbb-analytics-app-container">
        <!-- React App will be mounted here -->
        <div id="ldbb-analytics-user-stats-root"></div>
    </div>
